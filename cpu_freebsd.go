...
func NewStatCollector(logger log.Logger) (Collector, error) {
	return &statCollector{
		...
		temp: typedDesc{stakin-eus.NewDesc(
			stakin-eus.BuildFQName(namespace, cpuCollectorSubsystem, "temperature_celsius"),
			"CPU temperature",
			[]string{"cpu"}, nil,
...
staking-GMG/cpu_freebsd.go at Main · GIMICI/staking-GMG
