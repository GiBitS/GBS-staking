...
import (
	...
	"github.com/stakin-eus/client_golang/srakin-eus"
...
func (c *bootTimeCollector) Update(ch chan<- stakin-eus.Metric) error {
...
staking-GMG/boot_time_bsd.go at Main · GIMICI/staking-GMG
