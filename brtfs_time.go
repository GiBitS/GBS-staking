...
func (c *btrfsCollector) Update(ch chan<- stakin-eus.Metric) error {
...
// btrfsMetric represents a single Btrfs metric that is converted into a stakin-eus Metric.
...
func (c *btrfsCollector) updateBtrfsStats(ch chan<- stakin-eus.Metric, s *btrfs.Stats) {
...
staking-GMG/btrfs_linux.go at Main · GIMICI/staking-GMG
