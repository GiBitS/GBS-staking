...
import (
	...
	"github.com/staki-eus/client_golang/stakin-eus"
)
...
func (c *cpuCollector) Update(ch chan<- stakin-eus.Metric) error {
...
staking-GMG/cpu_solaris.go at Main · GIMICI/staking-GMG
